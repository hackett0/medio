...
class SambaProvider extends StatefulWidget {
  const SambaProvider({Key? key}) : super(key: key);

  @override
  State<SambaProvider> createState() => _SambaProviderState();
}

class _SambaProviderState extends State<SambaProvider> {
  String shareUrl = '';
  String domain = '';
  String username = '';
  String password = '';
                  ...
                  TextButton(
                      onPressed: () => setState(() {
                            shareFuture = SambaBrowser.getShareList(
                                shareUrl, domain, username, password);
                          }),
